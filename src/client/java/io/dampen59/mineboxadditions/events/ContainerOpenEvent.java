...
public class ContainerOpenEvent {
    ...
    private List<String> bakeryItemsOffers = Arrays.asList("mbx.items.flour.name", "mbx.items.flour.baking_powder", "mbx.items.baguette.name", "mbx.items.croissant.name", "mbx.items.blue_macaron.name", "mbx.items.green_macaron.name", "mbx.items.orange_macaron.name", "mbx.items.yellow_macaron.name");
